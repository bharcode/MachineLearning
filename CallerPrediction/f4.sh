...
hadoop jar mahout-core-0.7-job.jar org.apache.mahout.classifier.df.tools.Describe -p ~/kgl_caller_pred/mobile/train.csv -f ~/kgl_caller_pred/mobile/mobile.info -d N 5 C 5 N L
if [ $? -ne 0 ]; then
