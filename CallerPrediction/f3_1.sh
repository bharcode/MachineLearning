...
hadoop jar mahout-core-0.7-job.jar org.apache.mahout.classifier.df.tools.Describe -p ~/kgl_caller_pred/mobile/train.csv -f ~/kgl_caller_pred/mobile/mobile.info -d I 7 C 5 N C L
if [ $? -ne 0 ]; then
